...
trait SpecBase extends AnyWordSpec with TestSuite with FeatureSwitching with Matchers {
  ...
  lazy val agencyFakeRequest = fakeRequest.withSession(SessionKeys.userType -> Json.toJson[WhoAreYou](Agency).toString)
  ...
  lazy val workerFakeRequest = fakeRequest.withSession(SessionKeys.userType -> Json.toJson[WhoAreYou](Worker).toString)
  ...
  lazy val hirerFakeRequest = fakeRequest.withSession(SessionKeys.userType -> Json.toJson[WhoAreYou](Hirer).toString)

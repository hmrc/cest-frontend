  ...
  "Messages file" should {
    ...
    "for the Setup Section" should {
      ...
      "have the correct error messages for the ContractStartedPage" in {
        Messages("worker.contractStarted.error.required") mustBe ContractStartedMessages.Worker.error
        Messages("hirer.contractStarted.error.required") mustBe ContractStartedMessages.Hirer.error
      }
    }
    ...
    "for the Control Section" should {
      ...
      "have the correct error messages for the MoveWorkerPage" in {
        Messages("worker.moveWorker.error.required") mustBe MoveWorkerMessages.Worker.error
        Messages("hirer.moveWorker.error.required") mustBe MoveWorkerMessages.Hirer.error
      }

      "have the correct error messages for the HowWorkIsDonePage" in {
        Messages("worker.howWorkIsDone.error.required") mustBe HowWorkIsDoneMessages.Worker.error
        Messages("hirer.howWorkIsDone.error.required") mustBe HowWorkIsDoneMessages.Hirer.error
      }

      "have the correct error messages for the ScheduleOfWorkingHoursPage" in {
        Messages("worker.scheduleOfWorkingHours.error.required") mustBe ScheduleOfWorkingHoursMessages.Worker.error
        Messages("hirer.scheduleOfWorkingHours.error.required") mustBe ScheduleOfWorkingHoursMessages.Hirer.error
      }

      "have the correct error messages for the ChooseWhereWorkPage" in {
        Messages("worker.chooseWhereWork.error.required") mustBe ChooseWhereWorkMessages.Worker.error
        Messages("hirer.chooseWhereWork.error.required") mustBe ChooseWhereWorkMessages.Hirer.error
      }
    }
    ...
    "for the Financial Risk Section" should {
      ...
      "have the correct error messages for the HowWorkerIsPaidPage" in {
        Messages("worker.howWorkerIsPaid.error.required") mustBe HowWorkerIsPaidMessages.Worker.error
        Messages("hirer.howWorkerIsPaid.error.required") mustBe HowWorkerIsPaidMessages.Hirer.error
      }

      "have the correct error messages for the PutRightAtOwnCostsPage" in {
        Messages("worker.putRightAtOwnCost.error.required") mustBe PutRightAtOwnCostsMessages.Worker.error
        Messages("hirer.putRightAtOwnCost.error.required") mustBe PutRightAtOwnCostsMessages.Hirer.error
      }
    }

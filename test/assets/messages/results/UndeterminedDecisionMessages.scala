...
object UndeterminedDecisionMessages extends BaseResultMessages {
  ...
  object WorkerIR35 {
    ...
    val doNextP2 = "You could also read guidance in the Employment Status Manual (opens in new tab). This will provide you with more information about determining your employment status for tax purposes."
  ...
  object HirerPAYE {
    ...
    val doNextP2 = "You could also read guidance in the Employment Status Manual (opens in new tab). This will provide you with more information about determining the employment status of a worker for tax purposes."
    val doNextP3 = "If you need more help on how to answer the questions within the tool, you can contact HMRC’s Employment Status and Intermediaries helpline."
  }
  ...
  object Agent {
    ...
    val doNext_p2 = "You could also read guidance in the Employment Status Manual (opens in new tab). This will provide you with more information about determining the employment status of a worker for tax purposes."
  }
